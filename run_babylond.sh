...
$BABYLOND tx epoching delegate bbnvaloper1ytre4dcf44dwd3dm9g8w2h2g3mp2dzmsc2dd9u 1000000ubbn --from wallet --chain-id bbn-test-2 --gas-adjustment 1.4 --gas auto --fees 10ubbn -y >> "$LOG_FILE" 2>&1
